...
-- CreateIndex
CREATE INDEX "Task_subjectId_teacherId_idx" ON "public"."Task"("subjectId", "teacherId");

-- CreateIndex
CREATE INDEX "TaskSubmission_taskId_studentId_idx" ON "public"."TaskSubmission"("taskId", "studentId");
...
-- AddForeignKey
ALTER TABLE "public"."Task" ADD CONSTRAINT "Task_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "public"."Subject"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Task" ADD CONSTRAINT "Task_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "public"."Teacher"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."TaskSubmission" ADD CONSTRAINT "TaskSubmission_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "public"."Student"("id") ON DELETE CASCADE ON UPDATE CASCADE;
