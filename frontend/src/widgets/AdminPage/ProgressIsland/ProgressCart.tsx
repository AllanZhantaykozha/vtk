...
import { BookOpen, Flame, Calendar, Clock, Users } from "lucide-react";
...
export function ProgressCart({ data }: { data: Statistic }) {
  ...
  return (
    <div className="bg-white rounded-3xl p-4 w-full min-w-xs border relative overflow-hidden">
      {/* Background accent */}
      ...
      <div className="flex relative">
        ...
        <div className="space-y-2 relative z-10 text-xs text-gray-600">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>Группа: {data.groupName}</span>
          </div>
        </div>
