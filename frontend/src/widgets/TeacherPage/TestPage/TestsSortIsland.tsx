// src/widgets/TeacherPage/TestPage/TeacherTestsSortIsland.tsx
"use client";

import { Subject } from "@/src/entities/Subject/types";
import { useSubjectStore } from "@/src/shared/lib/stores/subjectsStore";
import { TestParams, useTestsStore } from "@/src/shared/lib/stores/testStore";
import { Select } from "@/src/shared/ui/Select";
import { useEffect, useState } from "react";

export function TeacherTestsSortIsland() {
  ...
  const [localFilters, setLocalFilters] = useState<TestParams>({
    title: "",
    description: "",
    subject: "",
    dateFrom: "",
  ...
  function applyFiltersAndSort() {
    fetchTests(localFilters);
  }

  return (
    <div className="w-full bg-white rounded-3xl p-8">
      <div className="text-lg font-semibold mb-4">
        Фильтрация и сортировка моих тестов
      </div>
